...
import { customStyles } from '@/assets/styles/global.styles'
  ...
  const onSignUpPress = async () => {
    ...
    try {
      ...
      if(err.errors?.[0]?.code === "form_identifier_exists") {
        setErr("The email address in already in use. Please try again.");
      } else {
        setErr("Passwords must be 8 chracters or more.");
      }
    }
  }
